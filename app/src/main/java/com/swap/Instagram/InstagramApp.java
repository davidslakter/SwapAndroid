...
import com.swap.Instagram.InstagramDialog.OAuthDialogListener;
...
public class InstagramApp {
			...
			public void run() {
				...
				try {
					...
					String name = jsonObj.getJSONObject("user").getString(
							"full_name");
					String profilePicture = jsonObj.getJSONObject("user").getString(
							"profile_picture");
	...
	public String getProfilePicture() {
		return mSession.getProfilePicture();
	}
