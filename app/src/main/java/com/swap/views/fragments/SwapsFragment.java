...
public class SwapsFragment extends Fragment {
    ...
    private void prepareUserData() {
        ...
        if (swapsUserList != null && swapsUserList.size() > 0) {
            swapsUserList.clear();
        }
    ...
    private class getUserSwapsListDate extends AsyncTask<Object, Object, ArrayList<SwapHistory>> {
        ...
        protected ArrayList<SwapHistory> doInBackground(Object... objects) {
            return SwapUser.getSwapHistory(getActivity(), username);
        }
        ...
        protected void onPostExecute(ArrayList<SwapHistory> swapHistories) {
            ...
            if (swapHistories != null && swapHistories.size() != 0) {
                ...
                // false for swap and it will be true for swapped
                swapsAdapter = new SwapsAdapter(swapHistories, getActivity(), true);
