...
import com.swap.models.ItemToDisplay;
...
public class AppHelper {
    ...
    public static final String userPoolId = "us-east-1_YWiyB9cSt";

    /**
     * Add you app id
     */

    public static final String clientId = "4aosg5oj8fcqiv20uf1mic1sds";
    ...
    public static final String clientSecret = "i1v063lb331rq6f8r8jc9fldtomfv3ooqglpjupkng2isa8apq7";

    /**
     * Set Your Users Pools region.
     * e.g. if your user pools are in US East (N Virginia) then set cognitoRegion = Regions.US_EAST_1.
     */
    public static final Regions cognitoRegion = Regions.US_EAST_1;

    // Users details from the service

    private static CognitoUserSession currSession;
    private static CognitoUserDetails userDetails;

    // Users details to display - they are the current values, including any local modification
    ...
    private static void setData() {
        ...
        attributeDisplaySeq.add("profile");
        attributeDisplaySeq.add("picture");
        ...
        signUpFieldsC2O.put("Profile", "profile");
        signUpFieldsC2O.put("Picture", "picture");
        ...
        signUpFieldsO2C.put("profile", "Profile");
        signUpFieldsO2C.put("picture", "Picture");
    ...
    // Code to access Dynamo database.
}
